...
public class ModelManager implements Model
{
  ...
  {
    list.addExercise((client.model.Exercise) new Exercise(3, 1, "Observer"));
    list.addExercise((client.model.Exercise) new Exercise(1, 2, "Threads"));
    list.addExercise((client.model.Exercise) new Exercise(1, 1, "Threads"));
    list.addExercise((client.model.Exercise) new Exercise(2, 2, "State"));
  ...
  @Override public Exercise editExercise(String number, Exercise exercise)
  {
    ...
    list.addExercise((client.model.Exercise) exercise);
